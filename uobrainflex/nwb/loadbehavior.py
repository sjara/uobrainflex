...
def savitzky_golay(y, window_size, order, deriv=0, rate=1):
    ...
    filter to be used for smoothing raw pupil and running speed data
...
def fetch_trial_beh_measures(trial_data,behavior_measures):
    ...
    # filter and normalize pupil diameter
    ...
    filt_pup = savitzky_golay(raw_pup, 1001, 2, deriv=0, rate=1)
