...
if save_figs ==1:
    save_folder = "C:\\Users\\admin\\Desktop\\figure dump\\" + subject
    if os.path.isdir(save_folder) == False:
        os.mkdir(save_folder)
        
    save_folder = save_folder + "\\HMM_States_" + str(num_states) + "\\"
    if os.path.isdir(save_folder) == False:
        os.mkdir(save_folder)
...
if save_figs ==1:
    plt.savefig(save_folder + str(num_states) +'_states_GLM_Weights.png')
plt.show()
...
if 1:
    for sess_id in range(0,len(true_choices)):
        ...
        plt.savefig(save_folder + f"Pstate_session{sess_id}.png")
        plt.show()
...
if save_figs ==1:
    plt.savefig(save_folder + "transition_matrix.png")
...
if save_figs ==1:
    plt.savefig(save_folder + "state_occupancy.png")
...
if save_figs ==1:
    plt.savefig(save_folder + "performance_by_state.png")
plt.show()  